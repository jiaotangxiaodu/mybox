 ...
 */
public class RBTreeTest extends TreeTest<Integer> implements IntegerTest {
    @Override
    public RBTree<Integer> newBox() {
        return CoreFactory.create(RBTree.class);
    }
    ...
    public void testInIterator() {
        ...
        RBTree<Integer> avl = (RBTree<Integer>) tempWrapper.avl;
    ...
    private TempWrapper initDefault() {
        ...
        tempWrapper.avl = CoreFactory.create(RBTree.class);
